...
export default function RenderRaw() {
  ...
  useEffect(() => {
    ...
    // Jalankan script inline (kalau ada)
    try {
      new Function('')();
    } catch (e) {
    ...
    // Muat file script eksternal (pastikan main.js ada di /public)
  ...
  return (
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: `<header class="p-6 border-b border-gray-800">
  ...
  <main class="flex-1 max-w-6xl mx-auto p-6">
    ...
    <section id="bts" class="tab-section hidden">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-1 auto-rows-[10rem]">
        ...
        <div class="col-span-2">
          <img class="film-thumb h-full w-full object-cover" src="assets/bts/bts5.jpg" alt="BTS Photo 5">
        </div>
        <div class="col-span-4 h-[12rem]">
          <img class="film-thumb h-full w-full object-cover" src="assets/bts/bts6.jpg" alt="BTS Photo 6">
        </div>
      </div>
    </section>
  </main>
